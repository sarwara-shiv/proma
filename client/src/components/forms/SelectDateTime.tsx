...
const SelectDateTime: React.FC<CustomDateTimePickerProps> = ({
  selectedDate,
  onDateChange,
  onChange,
  ...
  useEffect(() => {
    if (datePickerRef.current && setOpen) {
      ...
      }, 100); // Slight delay to ensure it opens correctly
    }
  }, []);
  ...
  return (
    <div className="relative inline-block w-full">
      ...
      <DatePicker
        ...
        className="hidden relative" // Hide the default date picker
      />
    </div>
  );
};
